...
export const TConnectModalProvider = memo(({ appName, appUrl, appIcon, bridgeUrl, apiKey, networkFilter, genericWalletUrl, children, onError, closeModalOnError, ...props }) => {
