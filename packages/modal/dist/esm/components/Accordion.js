...
export const Accordion = memo(({ title, open, onChangeOpen, className, children, ...props }) => {
    ...
    return (_jsxs(Col, { className: clsx('gap-y-4', className), ...props, children: [_jsxs(Row, { className: "justify-between", children: [_jsx(Row, { children: title }), _jsx(BaseButton, { className: "size-6 items-center justify-center rounded-full border border-solid border-lineGrey bg-white dark:border-white dark:bg-dark", onClick: toggleOpen, children: _jsx(Icon, { icon: (open ?? internalOpen) ? 'chevronUpSolid' : 'chevronDownSolid', className: "text-lineGrey dark:text-white", height: 12, width: 12 }) })] }), _jsx(Grid, { className: clsx('auto-rows-auto grid-cols-[repeat(auto-fill,minmax(4.313rem,1fr))] gap-1', !(open ?? internalOpen) && 'hidden'), children: children })] }));
});
