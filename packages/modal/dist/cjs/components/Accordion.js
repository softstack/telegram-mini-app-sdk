...
exports.Accordion = (0, react_1.memo)(({ title, open, onChangeOpen, className, children, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(Col_1.Col, { className: (0, clsx_1.clsx)('gap-y-4', className), ...props, children: [(0, jsx_runtime_1.jsxs)(Row_1.Row, { className: "justify-between", children: [(0, jsx_runtime_1.jsx)(Row_1.Row, { children: title }), (0, jsx_runtime_1.jsx)(BaseButton_1.BaseButton, { className: "size-6 items-center justify-center rounded-full border border-solid border-lineGrey bg-white dark:border-white dark:bg-dark", onClick: toggleOpen, children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { icon: (open ?? internalOpen) ? 'chevronUpSolid' : 'chevronDownSolid', className: "text-lineGrey dark:text-white", height: 12, width: 12 }) })] }), (0, jsx_runtime_1.jsx)(Grid_1.Grid, { className: (0, clsx_1.clsx)('auto-rows-auto grid-cols-[repeat(auto-fill,minmax(4.313rem,1fr))] gap-1', !(open ?? internalOpen) && 'hidden'), children: children })] }));
});
