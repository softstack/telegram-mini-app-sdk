...
exports.HorizontalIconTextButton = (0, react_1.memo)(({ icon, iconColorSuccess, text, className, ...props }) => ((0, jsx_runtime_1.jsxs)(BaseButton_1.BaseButton, { className: (0, clsx_1.clsx)('text-line h-5 flex-row items-center justify-center gap-x-1.5', className), ...props, children: [(0, jsx_runtime_1.jsx)(Row_1.Row, { className: "h-[20px] w-[20px]", children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { className: (0, clsx_1.clsx)(iconColorSuccess && 'text-success'), icon: icon, height: 20, width: 20 }) }), (0, jsx_runtime_1.jsx)(Row_1.Row, { className: "text-xs text-primaryText dark:text-primaryTextDark", children: text })] })));
