...
/**
 * Represents the supported Etherlink wallet applications.
 *
 * @typedef {('bitget' | 'metaMask' | 'safePal' | 'trust')} EtherlinkWalletApp
 *
...
/**
 * Interface representing the events for connecting to an Etherlink provider.
 * Extends the standard EIP1193 provider events.
 *
 * @extends EIP1193ProviderEvents
 *
 * @property {string} connectionString - The connection string used to connect to the Etherlink provider.
 */
...
/**
 * Options for connecting to an Etherlink provider.
 *
 * @property {string} bridgeUrl - The URL of the bridge to connect to.
 * @property {string} apiKey - The API key for authentication.
 * @property {EtherlinkWalletApp} [walletApp] - Optional wallet application to use.
 */
...
/**
 * Represents a serialized TConnect Etherlink provider.
 */
export interface SerializedTConnectEtherlinkProvider {
	...
	/**
	 * The wallet application used for Etherlink interactions.
	 */
