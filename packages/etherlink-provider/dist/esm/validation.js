...
import Joi from 'joi';
export const validateEtherlinkResponse = (value) => validateSchema(value, Joi.alternatives()
    .try(Joi.object({
    ...
    .required());
export const validateEtherlinkEvent = (value) => validateSchema(value, Joi.alternatives()
    .try(Joi.object({
